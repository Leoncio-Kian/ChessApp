...
public class GameBoard {
    ...
    public void init(){
       ...
       // setChessPiece(new UtilitiesPackage.Coordinate(0,3), new ChessPiece("ChessPieces.Queen", UtilitiesPackage.Color.WHITE, false));
        setChessPiece(blackKingLocation, new ChessPiece("ChessPieces.King", Color.BLACK, false));
       // setChessPiece(new UtilitiesPackage.Coordinate(7,3), new ChessPiece("ChessPieces.Queen", UtilitiesPackage.Color.BLACK, false));
    }
